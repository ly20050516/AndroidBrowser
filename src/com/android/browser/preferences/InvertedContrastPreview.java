...
public class InvertedContrastPreview extends WebViewPreview {
	...
	static final String[] THUMBS = new String[] { "thumb_google", "thumb_amazon", "thumb_cnn", "thumb_espn", "", // break
			"thumb_bbc", "thumb_nytimes", "thumb_weatherchannel", "thumb_picasa", };
	...
	protected void updatePreview(boolean forceReload) {
		...
		ws.setProperty(WebViewProperties.gfxInvertedScreen, bs.useInvertedRendering() ? "true" : "false");
		ws.setProperty(WebViewProperties.gfxInvertedScreenContrast, Float.toString(bs.getInvertedContrast()));
		if (forceReload) {
