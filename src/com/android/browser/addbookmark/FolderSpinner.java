...
/**
 * Special Spinner class with its own callback for when the selection is set,
 * which can be ignored by calling setSelectionIgnoringSelectionChange
 */
