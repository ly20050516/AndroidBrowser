...
public class SnapshotProvider extends ContentProvider {
	...
	final static class SnapshotDatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			db.execSQL("CREATE TABLE " + TABLE_SNAPSHOTS + "(" + Snapshots._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + Snapshots.TITLE
					+ " TEXT," + Snapshots.URL + " TEXT NOT NULL," + Snapshots.DATE_CREATED + " INTEGER," + Snapshots.FAVICON + " BLOB,"
					+ Snapshots.THUMBNAIL + " BLOB," + Snapshots.BACKGROUND + " INTEGER," + Snapshots.VIEWSTATE + " BLOB NOT NULL,"
					+ Snapshots.VIEWSTATE_PATH + " TEXT," + Snapshots.VIEWSTATE_SIZE + " INTEGER" + ");");
		}
	...
	static final String[] DELETE_PROJECTION = new String[] { Snapshots.VIEWSTATE_PATH, };
