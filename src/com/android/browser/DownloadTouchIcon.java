...
class DownloadTouchIcon extends AsyncTask<String, Void, Void> {
	...
	private final String mUserAgent; // Sites may serve a different icon to
										// different UAs
	 ...
	 * database entry for the given url. Used when the user creates a bookmark
	 * from within the bookmarks activity and there haven't been any redirects.
