...
/**
 * Simple bread crumb view Use setController to receive callbacks from user
 * interactions Use pushView, popView, clear, and getTopData to change/access
 * the view stack
 */
public class BreadCrumbView extends LinearLayout implements OnClickListener {
	...
	private void addBackButton() {
		...
		mBackButton.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT));
