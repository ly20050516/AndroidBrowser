...
public abstract class ThreadedCursorAdapter<T> extends BaseAdapter {
	...
	public ThreadedCursorAdapter(Context context, Cursor c) {
		...
		mHandler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if (view == null || container.owner != ThreadedCursorAdapter.this || container.position != msg.what
						|| view.getWindowToken() == null || container.generation != mGeneration) {
					return;
				}
	...
	private void loadRowObject(int position, LoadContainer container) {
		if (container == null || container.position != position || container.owner != ThreadedCursorAdapter.this
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (container.position == position && container.owner == this && container.loaded && container.generation == mGeneration) {
