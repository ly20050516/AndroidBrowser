...
public class LogTag {
	 ...
	 * 
	 * @param url
	 *            the url of the new bookmark.
	 * @param where
	 *            the location from where the bookmark was added
	 */
	...
	/**
	 * Log when a page has finished loading with how much time the browser used
	 * to load the page.
	 * 
	 * Note that a redirect will restart the timer, so this time is not always
	 * how long it takes for the user to load a page.
	 * 
	 * @param url
	 *            the url of that page that finished loading.
	 * @param duration
	 ...
	 * 
	 * @param url
	 *            the url of the page that is being logged (old page).
	 * @param duration
