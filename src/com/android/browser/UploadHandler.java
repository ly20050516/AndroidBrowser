...
public class UploadHandler {
	...
	private void startActivity(Intent intent) {
		try {
			...
			try {
				...
				// disabled.
				Toast.makeText(mController.getActivity(), R.string.uploads_disabled, Toast.LENGTH_LONG).show();
			}
		}
	}
	...
	private Intent createChooserIntent(Intent... intents) {
		...
		chooser.putExtra(Intent.EXTRA_TITLE, mController.getActivity().getResources().getString(R.string.choose_upload));
		return chooser;
	}
