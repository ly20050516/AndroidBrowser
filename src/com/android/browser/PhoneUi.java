...
public class PhoneUi extends BaseUi {
	...
	public PhoneUi(Activity browser, UiController controller) {
		...
		browser.getTheme().resolveAttribute(com.android.internal.R.attr.actionBarSize, heightValue, true);
	...
	static class AnimScreen {
		...
		public void set(TitleBar tbar, WebView web) {
			...
			if (mContentBitmap == null || mContentBitmap.getWidth() != web.getWidth() || mContentBitmap.getHeight() != h) {
