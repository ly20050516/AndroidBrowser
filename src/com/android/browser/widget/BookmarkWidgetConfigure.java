...
public class BookmarkWidgetConfigure extends ListActivity implements OnClickListener, LoaderCallbacks<Cursor> {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAccountAdapter = new ArrayAdapter<BookmarkAccount>(this, android.R.layout.simple_list_item_1);
