...
public class TitleBar extends RelativeLayout {
	...
	private void setFixedTitleBar() {
		boolean isFixed = !mUseQuickControls && !mContext.getResources().getBoolean(R.bool.hide_title);
		// If getParent() returns null, we are initializing
		ViewGroup parent = (ViewGroup) getParent();
		if (mIsFixedTitleBar == isFixed && parent != null)
			return;
...
//		mShowing = false;
	...
	public boolean wantsToBeVisible() {
		return inAutoLogin() || (mSnapshotBar != null && mSnapshotBar.getVisibility() == View.VISIBLE && mSnapshotBar.isAnimating());
	}
