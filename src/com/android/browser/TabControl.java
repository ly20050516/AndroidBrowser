...
class TabControl {
	 ...
	 * Create a new tab.
	 * 
	 * @return The newly createTab or null if we have reached the maximum number
	 *         of open tabs.
	 */
	...
	/**
	 * Create a new tab with default values for closeOnExit(false), appId(null),
	 * url(null), and privateBrowsing(false).
	 */
	Tab createNewTab() {
	...
	/**
	 * save the tab state: current position position sorted array of tab ids for
	 * each tab id, save the tab state
	 * 
	 * @param outState
	 * @param saveImages
	 */
	 ...
	 * current tab id is returned. This can be passed to restoreState below in
	 * order to restore the correct tab. Otherwise, -1 is returned and the state
	 * cannot be restored.
	 */
	 ...
	 * 
	 * @param currentId
	 *            The tab id to restore.
	 * @param inState
	 *            The saved state of all the tabs.
	 * @param restoreIncognitoTabs
	 *            Restoring private browsing tabs
	 * @param restoreAll
	 *            All webviews get restored, not just the current tab (this does
	 *            not override handling of incognito tabs)
	 */
	 ...
	 *            When true, enables private browsing in the new WebView.
	 */
	 ...
	 * 
	 * @param newTab
	 *            The new tab. If newTab is null, the current tab is not set.
	 */
